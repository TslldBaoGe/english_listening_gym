...
function tick() {
  ...
  for (const m of meteors) {
    ...
    const head = m.green ? '0, 255, 156' : '190, 220, 255'
...
.bg-glow-1 {
  ...
  left: -140px;
  top: -120px;
  background: radial-gradient(circle, rgba(0, 255, 156, 0.13), transparent 70%);
...
.bg-glow-3 {
  ...
  left: 30%;
  bottom: -220px;
  background: radial-gradient(circle, rgba(0, 255, 156, 0.08), transparent 70%);
